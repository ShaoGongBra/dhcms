<?php exit;?>0015366282514e1ea53498efd306e23b5acb034039d9s:5776:"a:2:{s:8:"template";s:5712:"<!DOCTYPE html>
<html lang="zh-cn">
<head>
    ...
    var duxConfig = {
        ...
        'baseDir' : '/public/js/',
        'baseUrl' : '/',
        'uploadUrl' : "<?php echo $_SERVER['PHP_SELF'];?>?r=dhcms/AdminUpload/upload",
        //自定义配置
        'libDir' : '/public/lib/js/',
        'sessId'  : '<?php echo session_id();?>',
        'editorUploadUrl' : "<?php echo $_SERVER['PHP_SELF'];?>?r=dhcms/AdminUpload/editor",
        };
    </script>
...
<body>
    <div class="dux-head clearfix">
        <div class="dux-logo">
            <a href="http://www.dhgop.com" target="_blank">
                <img src="/public/lib/images/logo.png" alt="dhcms后台管理系统" />
            </a>
...
</html>";s:12:"compile_time";i:1505092251;}";