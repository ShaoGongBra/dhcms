<?php exit;?>00153662944524bf710596f91cc9634190419911d9efs:8079:"a:2:{s:8:"template";s:8015:"<form method="post" class="form-x dux-form form-auto" id="form" action="<?php echo url('performance');?>">
        ...
        <div class="panel-body">
           <div class="form-group">
			...
			<div class="form-group">
                ...
                <div class="field">
                        <div class="button-group button-group-small radio">
                            <?php if ($info['API_SWITCH']){ ?>
                            <label class="button active"><input name="API_SWITCH" value="true" checked="checked" type="radio">
                            <?php }else{ ?>
                            <label class="button"><input name="API_SWITCH" value="true" type="radio">
                            <?php } ?>
                            <span class="icon icon-check"></span> 开启</label>
                            <?php if (!$info['API_SWITCH']){ ?>
                            <label class="button active"><input name="API_SWITCH" checked="checked" value="false" type="radio">
                            <?php }else{ ?>
                            <label class="button"><input name="API_SWITCH" value="false" type="radio">
                            <?php } ?>
                            <span class="icon icon-times"></span> 关闭</label>
                        </div>
                        <div class="input-note">开启后访问API需要通过密钥访问</div>
                    </div>
            </div>
            <div class="form-group">
                <div class="label">
...
</script>";s:12:"compile_time";i:1505093445;}";