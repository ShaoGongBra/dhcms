<?php exit;?>0015366282528a24f79e4b55ee5753e01a9c868a06efs:8789:"a:2:{s:8:"template";s:8725:"<!--[if lte IE 8]>
            ...
            <div class="clearfix">
                <div class="media media-x ">
                    ...
                    <div class="media-body text-center">
                        <h2><strong><?php echo target('dhcms/Safe')->getCount(); ?>%</strong></h2>
                        安全检测
                    </div>
                </div>
            </div>
        ...
        <div class="panel dux-box dux-dashboard">
            <div class="clearfix">
                <div class="media media-x ">
                    ...
                    <div class="media-body text-center">
                        <h2><strong><?php echo target('dhcms/TotalVisitor')->curNum(); ?></strong></h2>
                        今日网站访问
                    </div>
                </div>
            </div>
        ...
        <div class="panel dux-box dux-dashboard">
            <div class="clearfix">
                <div class="media media-x ">
                    ...
                    <div class="media-body text-center">
                        <h2><strong><?php echo target('dhcms/TotalSpider')->curNum(); ?></strong></h2>
                        今日蜘蛛访问
                    </div>
                </div>
            </div>
        ...
        <div class="panel dux-box dux-dashboard">
            <div class="clearfix">
                <div class="media media-x ">
                    ...
                    <div class="media-body text-center">
                        <h2><strong><?php echo target('dhcms/TotalVisitor')->curApi(); ?></strong></h2>
                        今日API访问
                    </div>
                </div>
            </div>
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <?php echo config('DH_VER');?> (<?php echo config('DH_TIME');?>)</td>

                        </tr>
                        <tr>
                            <td align="right">最新版本：</td>
                            <td><a href="<?php echo url('dhcms/AdminUpdate/index');?>">检查版本</a>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><a href="http://www.dhgop.com" target="_blank">鼎华</a>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">开发团队：</td>
                            <td><a href="http://www.dhgop.com" target="_blank">鼎华研究院</a>
                            </td>
                        </tr>
						<tr>
                        ...
                        <tr>
                            <td align="right">模板手册：</td>
                            <td>请在群内获取
                            </td>
                        </tr>
                        <tr>
                            <td align="right">QQ交流群：</td>
                            <td>452098334</td>
                        </tr>
                    </tbody>
                </table>
...
<script>
    Do.ready('base', function () {
        ...
        $('#checkAuthorize').click(function(){
            $.post('<?php echo url("dhcms/AdminUpdate/Authorize");?>',{},function(data){
                if(data != ''){
                    $('#authorize').html(data);
                }else{
...
";s:12:"compile_time";i:1505092252;}";