...
CREATE TABLE IF NOT EXISTS `dh_admin_group` (
...
--
-- 转存表中的数据 `dh_admin_group`
--

INSERT INTO `dh_admin_group` (`group_id`, `name`, `base_purview`, `menu_purview`, `status`) VALUES
...
CREATE TABLE IF NOT EXISTS `dh_admin_log` (
...
CREATE TABLE IF NOT EXISTS `dh_admin_user` (
...
--
-- 转存表中的数据 `dh_admin_user`
--

INSERT INTO `dh_admin_user` (`user_id`, `group_id`, `username`, `password`, `nicename`, `email`, `status`, `level`, `reg_time`, `last_login_time`, `last_login_ip`) VALUES
(1, 1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '管理员', 'admin@dhcms.com', 1, 1, 1399361747, 1416968562, '127.0.0.1');
...
--
-- 表的结构 `dh_category_article`
--

CREATE TABLE IF NOT EXISTS `dh_category_article` (
...
--
-- 表的结构 `dh_category_page`
--

CREATE TABLE IF NOT EXISTS `dh_category_page` (
...
CREATE TABLE IF NOT EXISTS `dh_config` (
...
INSERT INTO `dh_config` (`name`, `data`) VALUES
('site_title', 'DhCms网站管理系统'),
('site_subtitle', '简单、易用、轻巧'),
('site_url', ''),
('site_keywords', 'dhcms'),
('site_description', ''),
('site_email', 'admin@dhcms.com'),
('site_copyright', 'dhcms'),
('site_statistics', ''),
('tpl_name', 'default'),
('tpl_index', 'index'),
('tpl_search', 'search'),
...
--
-- 表的结构 `dh_config_upload`
--

CREATE TABLE IF NOT EXISTS `dh_config_upload` (
...
--
-- 转存表中的数据 `dh_config_upload`
--

INSERT INTO `dh_config_upload` (`id`, `name`, `upload_size`, `upload_exts`, `upload_replace`, `thumb_status`, `water_status`, `thumb_type`, `thumb_width`, `thumb_height`, `water_image`, `water_position`) VALUES
...
CREATE TABLE IF NOT EXISTS `dh_content` (
...
--
-- 表的结构 `dh_content_article`
--

CREATE TABLE IF NOT EXISTS `dh_content_article` (
...
--
-- 表的结构 `dh_ext_guestbook`
--

CREATE TABLE IF NOT EXISTS `dh_ext_guestbook` (
...
CREATE TABLE IF NOT EXISTS `dh_field` (
...
INSERT INTO `dh_field` (`field_id`, `fieldset_id`, `name`, `field`, `type`, `tip`, `verify_type`, `verify_data`, `verify_data_js`, `verify_condition`,`issearch`, `default`, `sequence`, `errormsg`, `config`) VALUES
(1, 1, '昵称', 'name', 1, '', 'regex', 'cmVxdWlyZQ==', 'Kg==', 1, 1,'', 0, '', ''),
(2, 1, '邮箱', 'email', 1, '', 'regex', 'ZW1haWw=', 'ZQ==', 1, '', 1, 1,'', ''),
...
CREATE TABLE IF NOT EXISTS `dh_fieldset` (
...
INSERT INTO `dh_fieldset` (`fieldset_id`, `table`, `name`) VALUES
(1, 'guestbook', '留言板');

-- --------------------------------------------------------

--
-- 表的结构 `dh_fieldset_expand`
--

CREATE TABLE IF NOT EXISTS `dh_fieldset_expand` (
  `fieldset_id` int(10) DEFAULT NULL,
...
--
-- 表的结构 `dh_fieldset_form`
--

CREATE TABLE IF NOT EXISTS `dh_fieldset_form` (
  `fieldset_id` int(10) DEFAULT NULL,
...
--
-- 转存表中的数据 `dh_fieldset_form`
--

INSERT INTO `dh_fieldset_form` (`fieldset_id`, `show_list`, `show_info`, `list_page`, `list_where`, `list_order`, `tpl_list`, `tpl_info`, `post_status`, `post_msg`, `post_return_url`) VALUES
(1, 1, 0, 10, '', 'data_id desc', 'guestbook', 'guestbook', 1, '留言发布成功！', '');

-- --------------------------------------------------------

--
-- 表的结构 `dh_field_expand`
--

CREATE TABLE IF NOT EXISTS `dh_field_expand` (
...
CREATE TABLE IF NOT EXISTS `dh_field_form` (
  `field_id` int(10) DEFAULT NULL,
...
--
-- 转存表中的数据 `dh_field_form`
--

INSERT INTO `dh_field_form` (`field_id`, `post`, `show`, `search`) VALUES
(1, 1, 1, 1),
(2, 1, 1, 1),
(3, 1, 1, 1),
(4, 0, 1, 1);
...
CREATE TABLE IF NOT EXISTS `dh_file` (
...
CREATE TABLE IF NOT EXISTS `dh_fragment` (
...
CREATE TABLE IF NOT EXISTS `dh_position` (
...
INSERT INTO `dh_position` (`position_id`, `name`, `sequence`) VALUES
(1, '首页推荐', 0);
...
CREATE TABLE IF NOT EXISTS `dh_tags` (
...
CREATE TABLE IF NOT EXISTS `dh_tags_has` (
  `content_id` int(10) DEFAULT NULL,
...
--
-- 表的结构 `dh_total_spider`
--

CREATE TABLE IF NOT EXISTS `dh_total_spider` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `time` int(10) DEFAULT NULL,
...
--
-- 表的结构 `dh_total_visitor`
--

CREATE TABLE IF NOT EXISTS `dh_total_visitor` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `time` int(10) DEFAULT NULL,
...
-- --------------------------------------------------------
--
-- 表的结构 `dh_total_spider_info`
--

CREATE TABLE IF NOT EXISTS `dh_total_spider_info` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
