...
class ContentModel extends BaseModel {
    ...
    public function delData($contentId){
        ...
        $fieldsetInfo = target('dhcms/Fieldset')->getInfoClassId($info['class_id']);
        //删除扩展字段
        if(!empty($fieldsetInfo)){
            $expandModel = target('dhcms/FieldData');
        ...
        //删除TAG关联
        target('dhcms/TagsHas')->delData($map);
        return $status;
    }
    ...
    public function saveExtData($data){
        ...
        //获取字段集信息
        $fieldsetInfo = target('dhcms/Fieldset')->getInfoClassId($classId);
        //保存扩展字段
        if(!empty($fieldsetInfo)){
            $expandModel = target('dhcms/FieldData');
            //设置模型信息
    ...
    public function hasTags($keywords, $contentId){
        ...
        //设置模型
        $TagsHasModel = target('dhcms/TagsHas');
        $TagsModel = target('dhcms/Tags');
        //删除关联
        $where = array();
    ...
    public function getImage(){
        ...
        return target('dhcms/ContentTools')->getImage($content, $getImageNum);
    }
