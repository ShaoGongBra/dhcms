...
class AdminUpdateController extends AdminController {
    ...
    public $domain = 'http://www.dhgop.com/index.php?r=/';
    /**
     * 当前模块参数
     */
    ...
    public function unzip(){
        ...
        $dir = $updateDir.'tmp_'.config('DH_TIME');
    ...
    public function upfile(){
        ...
        //更新SQL文件
        $file = ROOT_PATH.'update/'.config('DH_TIME').'.sql';
        if(is_file($file)){
            $sqlData = \framework\ext\Install::mysql($file, 'DH_', $data['DB_PREFIX']);
            //开始导入数据库
    ...
    public function Authorize(){
        $url = 'http://www.dhgop.com/index.php?r=service/Authorize/index';
